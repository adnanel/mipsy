...
public class InstructionLb extends Instruction {
    ...
    public InstructionLb(List<String> args) {
        super(args);

        this.instruction = "lb";

        if ( args.size() != 2 )
            throw new IllegalArgumentException("Invalid arguments passed to lb! Expected 2, given " + args.size());
    ...
    public String toString() {
        return String.format("lb %s, %s(%s)", destReg, "0x" + Integer.toHexString(offset), baseReg);
    }
}
